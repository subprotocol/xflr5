...
private:
	...
	double   m_ControlGain[4*MAXCONTROLS];      /**< the scaling factor for each of the control surfaces */
	...
	QString  m_PlrName;           /**< the polar's name */
	...
	QString  m_UFOName;           /**< the name of the parent wing or plane */
	...
	QList <double>  m_ZCP;        /**<  centre of pressure Z-position relative to the wing's root LE */
