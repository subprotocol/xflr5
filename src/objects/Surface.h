...
private :
	CVector SideA[MAXCHORDPANELS];     /**< the array of points on the left foil's mid-line*/
	CVector SideB[MAXCHORDPANELS];     /**< the array of points on the right foil's mid-line*/
	CVector SideA_T[MAXCHORDPANELS];   /**< the array of points on the left foil's top-line*/
	CVector SideB_T[MAXCHORDPANELS];   /**< the array of points on the right foil's top-line*/
	CVector SideA_B[MAXCHORDPANELS];   /**< the array of points on the left foil's bottom-line*/
	CVector SideB_B[MAXCHORDPANELS];   /**< the array of points on the right foil's bottom-line*/
	...
	double m_xPointA[MAXCHORDPANELS];        /**< the chordwise relative position of the VLM panel left corner points at side A */
	double m_xPointB[MAXCHORDPANELS];        /**< the chordwise relative position of the VLM panel right corner points at side B */
