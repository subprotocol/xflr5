...
void CWPolar::Copy(CWPolar *pWPolar)
{
	...
	for(i=0; i<size; i++)
	{
		...
		m_ZCP.insert(i,        pWPolar-> m_ZCP[i]);
...
void CWPolar::GetUFOPlrVariableName(int iVar, QString &Name)
{
	...
	switch (iVar)
	{
		...
		case 4:
			...
			break;
		case 5:
			Name = QObject::tr("Cm");// Total Pitching moment coef.
			break;
		case 6:
			Name = QObject::tr("VCm");// Viscous Pitching moment coef.
			break;
		case 7:
			Name = QObject::tr("ICm");// Induced Pitching moment coef.
			break;
		case 8:
			Name = QObject::tr("Cl");// Total Rolling moment coef.
			break;
		case 9:
			Name = QObject::tr("Cn");// Total Yawing moment coef.
			break;
		case 10:
			Name = QObject::tr("VCn");// Profile yawing moment
			break;
		case 11:
			Name = QObject::tr("ICn");// Induced yawing moment
			break;
		case 12:
		...
		case 17:
			...
			break;
		case 18:
			Name = QObject::tr("Vx ")+StrSpeed;
			break;
		case 19:
			Name = QObject::tr("Vz ")+StrSpeed;
			break;
		case 20:
			Name = QObject::tr("V ")+StrSpeed;
			break;
		case 21:
			Name = QObject::tr("Gamma");
			break;
		case 22:
			Name = QObject::tr("Pitching Moment");
			break;
		case 23:
			Name = QObject::tr("Rolling Moment");
			break;
		case 24:
			Name = QObject::tr("Yawing Moment");
			break;
		case 25:
			Name = QObject::tr("XCP ")+ StrLength;
			break;
		case 26:
			Name = QObject::tr("YCP ")+ StrLength;
			break;
		case 27:
			Name = QObject::tr("ZCP ")+ StrLength;
			break;
		case 28:
			Name = QObject::tr("BM ")+ StrMoment;
			break;
		case 29:
			Name = QObject::tr("m.g.Vz (W)");
			break;
		case 30:
			Name = QObject::tr("Efficiency");
			break;
		case 31:
			Name = "(XCp-XCG)/MAC(%)";
			break;
		case 32:
			Name = QObject::tr("ctrl");
			break;
		case 33:
			Name = QObject::tr("CY");
			break;
		case 34:
			...
			break;
		case 35:
			Name = QObject::tr("Ph. Freq(Hz)");
			break;
		case 36:
			Name = QObject::tr("Ph. Damping");
			break;
		case 37:
			Name = QObject::tr("SP Freq (Hz)");
			break;
		case 38:
			Name = QObject::tr("SP Damping");
			break;
		case 39:
			Name = QObject::tr("DR Freq(Hz)");
			break;
		case 40:
			Name = QObject::tr("DR Damping");
			break;
		case 41:
			Name = QObject::tr("Roll Damping");
			break;
		case 42:
			Name = QObject::tr("Spiral Damping");
			break;
		default:
			Name = QObject::tr("Alpha");
			break;
