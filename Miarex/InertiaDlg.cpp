...
void InertiaDlg::SetupLayout()
{
	...
	m_pctrlObjectMassLabel->setAlignment(Qt::AlignRight|Qt::AlignVCenter);
	...
	CoGLayout->addWidget(m_pctrlObjectMassLabel,1,1);
	CoGLayout->addWidget(m_pctrlObjectMass,1,2);
...
//	CoGLayout->addWidget(CoGLabel,2,1);
	...
	CoGLayout->addWidget(m_pctrlLengthUnit2,2,3);
